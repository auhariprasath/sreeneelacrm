...
CREATE TABLE public.event_coordination (
  ...
  coordinator_token text NOT NULL UNIQUE DEFAULT encode(gen_random_bytes(18), 'base64url'),
  client_status_token text NOT NULL UNIQUE DEFAULT encode(gen_random_bytes(18), 'base64url'),
  assigned_by uuid,
