...
import { Settings, KeyRound, LogOut, Sun, Moon, ClipboardList, CalendarDays, BarChart3, ArrowRightLeft, Megaphone, Shield, Users } from "lucide-react";
      ...
      <div className="space-y-2">
        ...
        {role === "super_admin" && (
          <Link to="/customers" className="block">
            <Button variant="outline" className="w-full justify-start min-h-[48px]"><Users className="h-4 w-4 mr-2" />Customers</Button>
          </Link>
        )}
        {role === "super_admin" && (
          <Link to="/not-interested" className="block">
            <Button variant="outline" className="w-full justify-start min-h-[48px]"><Users className="h-4 w-4 mr-2" />Not interested</Button>
          </Link>
        )}
        {role === "super_admin" && (
